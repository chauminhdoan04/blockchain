...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'CowManager', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.CowManager__factory>
getContractFactory(name: 'Counter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Counter__factory>

  getContractAt(name: 'CowManager', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.CowManager>
getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>

  deployContract(name: 'CowManager', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CowManager>
deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>

  deployContract(name: 'CowManager', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CowManager>
